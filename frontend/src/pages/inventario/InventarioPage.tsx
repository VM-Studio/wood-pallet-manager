...
import { useStockConsolidado, useMovimientosStock } from '../../hooks/useInventario';
      ...
      {!filtrado?.length ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          {filtrado.map((item: any) => {
            ...
            return (
              <div key={item.producto.id} className="card-base">
                {/* Header */}
                ...
                {/* Stock propio */}
                <div className="p-3 rounded-xl mb-3 text-center bg-gray-50">
                ...
                <div className="space-y-2 mb-4">
                  {item.porGalpon.map((g: any, i: number) => (
                    <div key={i} className="flex items-center justify-between p-2.5 rounded-xl border bg-gray-50 border-gray-100">
                      <div>
                        <p className="text-xs font-semibold text-gray-700 truncate max-w-35">
